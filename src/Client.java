...
public class Client
{
     ...
     *
     * @param str The string will be a single line from a status command sent to
     * the custom rcon server implementation. Example line:	0 20 name
     * exactname^7 1234567890
     */
